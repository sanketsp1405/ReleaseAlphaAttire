...
<body>
    <div class="sidebar">
        ...
        <select id="brandFilter" onchange="filterProducts()">
            ...
            <option value="Louis Philippe Sport">Louis Philippe Sport</option>
    ...
    <script>
        function filterProducts() {
            ...
            cards.forEach(card => {
                ...
                let priceMatch = priceFilter === 'all' || (priceFilter.split('-').length === 2 && cardPrice >= parseFloat(priceFilter.split('-')[0]) && cardPrice <= parseFloat(priceFilter.split('-')[1]));

...
<body>
    ...
    <div class="container">
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add_to_cart'])) {
            ...
            $stmt->bind_param("iiis", $userId, $product_id, $quantity, $image1); // Using $image1 correctly
    ...
    <script>
        function filterProducts() {
            ...
            cards.forEach(card => {
                ...
                sizeMatch = (sizeFilter === 'all' || cardSize === sizeFilter);
        ...
        function openProductDetail(name, price, image, description, image1, image2, image3) {
            const url = `productpage.html?name=${encodeURIComponent(name)}&price=${price}&image=${encodeURIComponent(image)}&description=${encodeURIComponent(description)}&image1=${encodeURIComponent(image1)}&image2=${encodeURIComponent(image2)}&image3=${encodeURIComponent(image3)}`;

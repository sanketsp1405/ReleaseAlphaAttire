...
<body>
    ...
    <div class="container">
        ...
        $sql = "SELECT id, name, price, image1, image2, image3, size, brand FROM products WHERE sub_category_id = 14";
    ...
    <script>
        function filterProducts() {
            ...
            cards.forEach(card => {
                ...
                let priceMatch = priceFilter === 'all' || (cardPrice >= parseFloat(priceFilter.split('-')[0]) && cardPrice <= parseFloat(priceFilter.split('-')[1]));

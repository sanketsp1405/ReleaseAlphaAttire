...
<body>
    <div class="sidebar">
        ...
        <select id="brandFilter" onchange="filterProducts()">
            ...
            <option value="Wild Stone">Wild Stone</option>
    ...
    <script>
        function filterProducts() {
            ...
            cards.forEach(card => {
                ...
                // Display or hide card based on filters
        ...
        function openProductDetail(name, price, image, description) {
            const url = `productpage.html?name=${encodeURIComponent(name)}&price=${encodeURIComponent(price)}&image=${encodeURIComponent(image)}&description=${encodeURIComponent(description)}`;

    ...
    <script>
        function filterProducts() {
            ...
            cards.forEach(card => {
                ...
                // Brand filtering
                brandMatch = brandFilter === 'all' || cardBrand === brandFilter;

                // Size filtering
                sizeMatch = sizeFilter === 'all' || cardSize === sizeFilter;

                // Display card if it matches all criteria
        ...
        function openProductDetail(name, price, image, brand, description, image1, image2, image3) {
            const url = `productpage.html?name=${encodeURIComponent(name)}&price=${price}&image=${image}&brand=${brand}&description=${description}&image1=${image1}&image2=${image2}&image3=${image3}`;
